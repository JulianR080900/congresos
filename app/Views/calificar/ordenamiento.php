            ...
            ?>
                                <div class="list-item" style="">
                                    <div class="item-content" style="">
                                        ...
                                        <input style="border: 0;height: 30%; width:80%; font-size: initial; font-size: 0.8rem" readonly type="text" value="<?php echo $nombre; ?>" name="posiciones[]">
                                    </div>
                                </div>
                                <?php
            $i++;
...
<script type="text/javascript">
    function confirmarDatos() {
        ...
        n = txt.length;
        if (n <= 20) {
            alert('Agradecemos que coloque una retroalimentaci贸n breve. (Al menos 20 caracteres)');
            //   e.preventDefault();
            console.log("llenar");
        } else {
