...
<body>
  <div class="row" id="img">
    <div class="col-md-4 text-center">
      <img src="<?php echo base_url("public/img/logos_redes/relep blanco.png") ?>" style="width: 45%; padding-top:30px" />
    </div>
    <div class="col-md-4 text-center">
      <img src="<?php echo base_url("public/img/logos_redes/relen blanco.png") ?>" style="width: 45%; padding-top:30px" />
    </div>
    <div class="col-md-4 text-center">
      <img src="<?php echo base_url("public/img/unla blanco.png") ?>" style="width: 40%; padding-top:30px" />
    </div>
