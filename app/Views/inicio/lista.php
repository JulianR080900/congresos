...
<div class="tabla">
    ...
    <br>
    <table style="margin: 0 auto;" class="display container" id="asistencia">
        <thead>
            <tr>
                ...
                <th style="width: 200px;">Clave de gafete</th>
...
setInterval(actualizar,1000);
 ...
 var fecha = "";
  ...
  function buscar_participante(){
      nombre_participante = document.getElementById("search").value;
        $.ajax({
            url: base_url + "/MainController/buscar_participante",
            type: "POST",
            data:{
            ...
            success: function(resp){
                var resultado = JSON.parse(resp);
                var div_participantes = document.getElementById('datos_participantes');
                div_participantes.innerHTML = resultado;
                // $('#asistencia').DataTable();
            },
                statusCode: {
                    400: function(xhr){
